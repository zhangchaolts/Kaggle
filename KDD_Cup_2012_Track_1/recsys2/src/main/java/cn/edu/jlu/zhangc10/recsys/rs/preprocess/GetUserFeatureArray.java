...
public class GetUserFeatureArray {
	...
	public static List<Integer> getFeaturePtrList(String userInfo) {
	...
	public static String getArray(String userInfo) {
		...
		//System.out.println(generate1DInfo(birthGroup, NUM_BIRTH_GROUPS));
		//System.out.println(generate1DInfo(sexGroup, NUM_SEX_GROUPS));
