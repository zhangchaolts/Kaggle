...
public class CalRatings {
	...
	private static String itemPtrPath = "data/track1/submission_matrix_iid";
	...
	//private static String resultMatrixPath = "data/track1/RR_40";
	private static String testPath = "data/track1/original/rec_log_test.txt";
	private static String ratingsPath = "data/track1/submission_ratings";
